  ...
  render(){
    ...
    if(this.props.charts.chartType=='pie'){
      ...
      <AppFrame >
       ...
       <Pie data={this.props.charts.data} cx={200} cy={200} innerRadius={70} outerRadius={90} fill="#82ca9d" label/>
       </PieChart>
      </AppFrame>
      ) 
    ...
    if (this.props.charts.chartType == 'bar') {
      return (
        <AppFrame >
          ...
          <BarChart width={600} height={300} data={this.props.charts.data}
